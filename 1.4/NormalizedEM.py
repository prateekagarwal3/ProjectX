...
<<<<<<< HEAD:WorkingCode/NormalizedEM.py
Strokes = 10
iterations = 1
N = 1454
=======
...
iterations = 100
N = 75
>>>>>>> f6bb14ad7b9ecaaa79cb74029aab9ab1cf565e6d:1.4/NormalizedEM.py
M = 1600
...
for em in xrange(iterations) :
	...
	print "End of E Step for Iteration No : " + str(em)
...
=======
	print "End of M Step - I for Iteration No : " + str(em)
>>>>>>> f6bb14ad7b9ecaaa79cb74029aab9ab1cf565e6d:1.4/NormalizedEM.py
	...
	print "End of M Step - II for Iteration No : " + str(em)
...
=======
	img.save("Strokes/StrokeImage" + str(k) + ".tif")	
>>>>>>> f6bb14ad7b9ecaaa79cb74029aab9ab1cf565e6d:1.4/NormalizedEM.py
